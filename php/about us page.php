    ...
    <header class="header">
      <div class="header__top">
        ...
        <div class="header__top-user">
          ...
          <a href="UserDashboard.php"><i class="fa fa-user"></i></a>
        </div>
...
<br>
  <div id="div1" style="" class="make-center">
<div class="mySlides fade">

       <a href="#"> <img  src="../images/img3.jpg" alt="logo" width="800"; height="400"; /></a>

</div>

<div class="mySlides fade">

  <a href="#"> <img  src="../images/img1.jpg" alt="logo" width="800"; height="400"; /></a>
  
</div>

<div class="mySlides fade">

    <a href="#"> <img  src="../images/img2.jpg" alt="logo" width="800";  height="400";/></a>
...
<br>
  <center><h2><font color="white">Our Team</font></h2></center> 
<br><br><br><br>
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
    	 <a href="#"> <img class="prof" src="../images/p1.png" alt="prof" width="200";  height="200"></a>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    	 <a href="#"> <img class="prof" src="../images/p2.png" alt="prof"  width="200";  height="200"   /></a>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    	 <a href="#"> <img class="prof" src="../images/p3.png" alt="prof"  width="200";  height="200"   /></a>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    	 <a href="#"> <img class="prof" src="../images/p4.png" alt="prof"  width="200";  height="200"   /></a>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    	 <a href="#"> <img class="prof" src="../images/p5.png" alt="prof"  width="200";  height="200"   /></a>
